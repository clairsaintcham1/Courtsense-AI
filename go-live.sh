...
#   DATABASE_URL   (optional) — passed as an env var when the site uses a DB.
...
# Empty for a personal-account token.
...
# Next.js is auto-detected by Vercel — no --prebuilt needed.
